...
const string GEN_UPDATE = "gen-update";
const string DYNAMIC_SS = "dynamic-ss";
const string DYNAMIC_TOPK = "dynamic-topk";
const string DYNAMIC_ONEHOP = "dynamic-onehop";
const string DYNAMIC_HYBRID = "dynamic-hybrid";
const string CALCULATE_ACCURACY = "calc-acc";
const string COMPARE_NO_UPDATE = "comp-no-up";

const string BIPPR = "bippr";
const string FORA = "fora";
const string FORA_NO_INDEX = "foran";
const string BATON = "baton";
...
const int DQUERY = 0;
const int DUPDATE = 1;
const int DSSQUERY = 2;
const int DTOPKQUERY = 3;
const int DOHQUERY = 4;
...
typedef pair<iMap<double>, iMap<double>> ReversePushidx;
typedef pair<iMap<double>, iMap<double>> Bwdidx;
typedef pair<iMap<double>, iMap<double>> Fwdidx;
typedef pair<iMap<int>, iMap<double>> Reuseidx;
